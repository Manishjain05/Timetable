...
public class first extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(202, 19, 64));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        char[] pass=new char[] {'h','e','l','l','o'};
        //char[] user=new char[] {'a','d','m','i','n'};
        char[] pass2=new char[] {};
        char[] pass1=jPasswordField1.getPassword();
        if(str1.equals(""))
        {
            JOptionPane.showMessageDialog(this,"Please enter user name"); System.out.println("false");
        }
        else if((Arrays.equals(pass,pass1)) && (str1.equals("admin"))){
            ...
            JOptionPane.showMessageDialog(this,"Incorrect details, Please enter correct details!");
        }
